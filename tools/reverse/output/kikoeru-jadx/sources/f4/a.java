...
public final class a implements Interpolator {
    ...
    public a(float[] fArr) {
        this.f6677a = fArr;
        this.f6678b = 1.0f / (fArr.length - 1);
    }
