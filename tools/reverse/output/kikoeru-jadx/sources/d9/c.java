...
public final class c extends n7.e {
    ...
    @Override // n7.e
    public final void e(z7.c cVar, Object obj) {
        switch (this.f5554o) {
            case 0:
                c9.a aVar = (c9.a) obj;
                jc.l.e(cVar, "statement");
                jc.l.e(aVar, "entity");
                cVar.c(1, aVar.f3766a);
            ...
            case 1:
                ...
                jc.l.e(cVar, "statement");
                jc.l.e(bVar, "entity");
                cVar.c(1, bVar.f3772a);
                cVar.v(2, bVar.f3773b);
                cVar.v(3, bVar.f3774c);
                break;
            case 2:
                c9.c cVar2 = (c9.c) obj;
                jc.l.e(cVar, "statement");
                jc.l.e(cVar2, "entity");
                cVar.c(1, cVar2.f3775a);
    ...
    public final String k() {
        switch (this.f5554o) {
            case 0:
                return "INSERT OR ABORT INTO `AccountBean` (`id`,`server`,`username`,`password`,`token`,`timestamp`) VALUES (nullif(?, 0),?,?,?,?,?)";
            case 1:
                return "INSERT OR ABORT INTO `BlacklistBean` (`id`,`type`,`value`) VALUES (nullif(?, 0),?,?)";
            case 2:
                return "INSERT OR ABORT INTO `DownloadBean` (`id`,`timestamp`,`rj`,`sourceId`,`releaseTime`,`tags`,`vas`,`circle`,`nsfw`,`has_subtitle`,`icon`,`name`,`workJson`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?)";
            case 3:
                return "INSERT OR ABORT INTO `HistoryBean` (`id`,`timestamp`,`rj`,`sourceId`,`releaseTime`,`tags`,`vas`,`circle`,`nsfw`,`has_subtitle`,`icon`,`name`,`workJson`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?)";
            case 4:
                return "INSERT OR ABORT INTO `LyricBean` (`id`,`rj`,`sourceId`,`nameBin`,`nameEnc`,`lyricBin`,`lyricEnc`,`duration`,`documentUri`,`zipInnerPath`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?)";
            case 5:
                return "INSERT OR ABORT INTO `ManualLRCBean` (`id`,`rj`,`sourceId`,`name`,`docName`,`documentUri`,`zipInnerPath`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
            default:
                return "INSERT OR ABORT INTO `SearchHistoryBean` (`id`,`timestamp`,`content`) VALUES (nullif(?, 0),?,?)";
        }
    }
}
