...
public abstract class j {
    ...
    public static final s f18686a = new s(0.31006f, 0.31616f);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final s f18687b = new s(0.34567f, 0.3585f);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final s f18688c = new s(0.32168f, 0.33767f);

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final s f18689d = new s(0.31271f, 0.32902f);

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final float[] f18690e = {0.964212f, 1.0f, 0.825188f};

    public static c a(c cVar) {
        if (b.a(cVar.f18651b, b.f18645a)) {
            q qVar = (q) cVar;
            s sVar = qVar.f18705d;
            s sVar2 = f18687b;
            if (!d(sVar, sVar2)) {
                return new q(qVar.f18650a, qVar.f18709h, sVar2, g(c(a.f18643b.f18644a, sVar.a(), sVar2.a()), qVar.f18710i), qVar.f18712k, qVar.f18715n, qVar.f18706e, qVar.f18707f, qVar.f18708g, -1);
            }
        }
        return cVar;
    }
    ...
    public static final boolean d(s sVar, s sVar2) {
        ...
        return Math.abs(sVar.f18726a - sVar2.f18726a) < 0.001f && Math.abs(sVar.f18727b - sVar2.f18727b) < 0.001f;
    }
    ...
    public static final g e(c cVar, c cVar2) {
        ...
        long j10 = cVar.f18651b;
        long j11 = b.f18645a;
        return (b.a(j10, j11) && b.a(cVar2.f18651b, j11)) ? new f((q) cVar, (q) cVar2) : new g(cVar, cVar2, 0);
    }
