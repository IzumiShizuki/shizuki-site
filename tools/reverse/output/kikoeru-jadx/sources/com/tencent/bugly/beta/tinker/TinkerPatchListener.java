...
public class TinkerPatchListener extends DefaultPatchListener {
    ...
    public TinkerPatchListener(Context context) {
        ...
        TinkerLog.i(TAG, t0.B(memoryClass, "application maxMemory:"), new Object[0]);
    ...
    public int patchCheck(String str, String str2) {
        ...
        if (iPatchCheck == 0) {
            ...
            if (propertiesFastGetPatchPackageMeta == null) {
                ...
                TinkerLog.i(TAG, h0.x("get platform:", propertiesFastGetPatchPackageMeta.getProperty(TinkerUtils.PLATFORM)), new Object[0]);
            }
        }
