...
public class TinkerReport {
    ...
    public static void onApplyCrash(Throwable th2) {
        ...
        reporter2.onReport(KEY_APPLIED_EXCEPTION);
    ...
    public static void onApplyInfoCorrupted() {
        ...
        reporter2.onReport(KEY_APPLIED_INFO_CORRUPTED);
    }
    ...
    public static void onLoadException(Throwable th2, int i10) {
        ...
        if (i10 == -4) {
            ...
            if (i10 != -2) {
                if (i10 == -1) {
                    reporter2.onReport(KEY_LOADED_UNKNOWN_EXCEPTION);
                }
            } else {
    ...
    public static void onLoadFileMisMatch(int i10) {
        ...
        if (i10 == 3) {
            reporter2.onReport(KEY_LOADED_MISMATCH_DEX);
        } else if (i10 == 5) {
            reporter2.onReport(KEY_LOADED_MISMATCH_LIB);
        } else {
            if (i10 != 6) {
                return;
            }
            reporter2.onReport(KEY_LOADED_MISMATCH_RESOURCE);
        }
    }
    ...
    public static void onLoadFileNotFound(int i10) {
        ...
        switch (i10) {
            case 1:
                reporter2.onReport(KEY_LOADED_MISSING_PATCH_FILE);
                break;
            case 2:
                reporter2.onReport(KEY_LOADED_MISSING_PATCH_INFO);
                break;
            case 3:
                reporter2.onReport(KEY_LOADED_MISSING_DEX);
                break;
            case 4:
                reporter2.onReport(KEY_LOADED_MISSING_DEX_OPT);
                break;
            case 5:
                reporter2.onReport(KEY_LOADED_MISSING_LIB);
                break;
            case 6:
                reporter2.onReport(KEY_LOADED_MISSING_RES);
                break;
        }
    }
