...
public final class d {
    ...
    public static int f22379d;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final AccessibilityNodeInfo f22380a;
    ...
    public d(AccessibilityNodeInfo accessibilityNodeInfo) {
        this.f22380a = accessibilityNodeInfo;
    }
    ...
    public final void a(int i10) {
        this.f22380a.addAction(i10);
    }

    public final void b(c cVar) {
        this.f22380a.addAction((AccessibilityNodeInfo.AccessibilityAction) cVar.f22377a);
    }

    public final ArrayList c(String str) {
        AccessibilityNodeInfo accessibilityNodeInfo = this.f22380a;
    ...
    public final boolean e(int i10) {
        Bundle extras = this.f22380a.getExtras();
    ...
    public final boolean equals(Object obj) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo2 = this.f22380a;
        ...
        return this.f22382c == dVar.f22382c && this.f22381b == dVar.f22381b;
    }
    ...
    public final void i(b1.e eVar) {
        this.f22380a.setRangeInfo((AccessibilityNodeInfo.RangeInfo) eVar.f1425a);
    }
    ...
    public final String toString() {
        ...
        if (i10 >= 34) {
            d.a.b(accessibilityNodeInfo, rect);
        } else {
        ...
        sb.append(i10 >= 30 ? m2.c.b(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.STATE_DESCRIPTION_KEY"));
        ...
        sb.append("; uniqueId: ");
        sb.append(i10 >= 33 ? d.j.d(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getString("androidx.view.accessibility.AccessibilityNodeInfoCompat.UNIQUE_ID_KEY"));
        sb.append("; checkable: ");
        sb.append(accessibilityNodeInfo.isCheckable());
        sb.append("; checked: ");
        int iA = i10 >= 36 ? d.b.a(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.CHECKED_KEY", accessibilityNodeInfo.isChecked() ? 1 : 0);
        String str = "PARTIAL";
        ...
        int iC = i10 >= 36 ? d.b.c(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.EXPANDED_STATE_KEY", 0);
        if (iC == 0) {
            str = "UNDEFINED";
        } else if (iC == 1) {
            str = "COLLAPSED";
        ...
        sb.append(i10 >= 34 ? d.a.c(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.CONTAINER_TITLE_KEY"));
        ...
        sb.append(i10 >= 33 ? d.j.e(accessibilityNodeInfo) : e(8388608));
        sb.append("; accessibilityDataSensitive: ");
        sb.append(i10 >= 34 ? d.a.d(accessibilityNodeInfo) : e(64));
        sb.append("; [");
        ...
        for (int i12 = 0; i12 < arrayList.size(); i12++) {
            ...
            Object obj = cVar.f22377a;
            Object obj2 = cVar.f22377a;
            String strD = d(((AccessibilityNodeInfo.AccessibilityAction) obj).getId());
            if (strD.equals("ACTION_UNKNOWN") && ((AccessibilityNodeInfo.AccessibilityAction) obj2).getLabel() != null) {
                strD = ((AccessibilityNodeInfo.AccessibilityAction) obj2).getLabel().toString();
            }
            sb.append(strD);
