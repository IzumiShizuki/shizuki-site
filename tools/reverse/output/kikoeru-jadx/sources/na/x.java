...
public final /* synthetic */ class x implements c0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final x f15768a;
    private static final uf.g descriptor;

    static {
        x xVar = new x();
        f15768a = xVar;
        b1 b1Var = new b1("com.cnl.kikoeru.utils.Uploader", xVar, 18);
        b1Var.b("login", false);
        b1Var.b("id", false);
    ...
    public final Object b(vf.b bVar) {
        ...
        aVarI.j(gVar);
        return new z(i11, strQ, iT, strQ2, strQ3, strQ4, strQ5, strQ6, strQ7, strQ8, strQ9, strQ10, strQ11, strQ12, strQ13, strQ14, strQ15, strQ16, zO);
    }
    ...
    public final void d(yf.t tVar, Object obj) {
        ...
        tVarA.v(gVar, 0, zVar.f15769a);
        tVarA.m(1, zVar.f15770b, gVar);
        tVarA.v(gVar, 2, zVar.f15771c);
        tVarA.v(gVar, 3, zVar.f15772d);
        tVarA.v(gVar, 4, zVar.f15773e);
        tVarA.v(gVar, 5, zVar.f15774f);
        tVarA.v(gVar, 6, zVar.f15775g);
        tVarA.v(gVar, 7, zVar.f15776h);
        tVarA.v(gVar, 8, zVar.f15777i);
        tVarA.v(gVar, 9, zVar.f15778j);
        tVarA.v(gVar, 10, zVar.f15779k);
        tVarA.v(gVar, 11, zVar.f15780l);
        tVarA.v(gVar, 12, zVar.f15781m);
        tVarA.v(gVar, 13, zVar.f15782n);
        tVarA.v(gVar, 14, zVar.f15783o);
        tVarA.v(gVar, 15, zVar.f15784p);
        tVarA.v(gVar, 16, zVar.f15785q);
        tVarA.c(gVar, 17, zVar.f15786r);
        tVarA.w(gVar);
    }
}
