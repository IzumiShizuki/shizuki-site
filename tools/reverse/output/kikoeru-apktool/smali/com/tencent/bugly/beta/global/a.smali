...
.method public static a(Landroid/graphics/Bitmap;IIF)Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-direct {v3, v8, v4}, Landroid/graphics/PaintFlagsDrawFilter;-><init>(II)V
    ...
    .line 19
    invoke-virtual {v1, v2, p3, p3, v6}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    invoke-direct {p1, v8, v8, p2, p3}, Landroid/graphics/Rect;-><init>(IIII)V

    .line 23
    invoke-virtual {v1, p0, p1, v7, v6}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public static a(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;)Z
    ...
    const-string v0, "contentUri is "

    const-string v1, "file location is "
    ...
    .line 52
    :try_start_2
    invoke-static {p1, v4}, Lcom/tencent/bugly/proguard/ca;->a(Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 60
    sget v4, Landroidx/core/content/FileProvider;->a:I
    :try_end_5
    ...
    iget-object v11, v11, Lcom/tencent/bugly/crashreport/common/info/a;->g:Ljava/lang/String;
    ...
    .line 64
    invoke-static {v2, v4, v6, v9, v8}, Lcom/tencent/bugly/proguard/ca;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 68
    invoke-virtual {p2, v2, v5}, Landroid/content/Intent;->setDataAndType(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Intent;
