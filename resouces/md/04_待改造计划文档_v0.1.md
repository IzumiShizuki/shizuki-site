...
- 已接入 Flyway 版本迁移（V1~V8），仍需在真实环境补一次全量迁移演练与回滚演练。
...
- 数据库规范 v1.1 已落地到迁移脚本：
  - 新增 `V5__rename_objects_to_standard.sql`
  - 新增 `V6__normalize_columns_and_time_fields.sql`
  - 新增 `V7__sensitive_data_hardening.sql`
  - 新增 `V8__create_standard_views.sql`
