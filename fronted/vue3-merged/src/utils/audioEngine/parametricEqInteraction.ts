 ...
 * 原路径: src/renderer/src/utils/parametricEqInteraction.ts
 * 移植说明: 逐字移植；仅类型 import 改为本地 ./equalizerTypes。
 */
import type { EqualizerBand, EqualizerFilterType } from './equalizerTypes'
