...
export function resolveTopMenuPresentation({ scrollTop = 0, manualExpanded = false, manualCollapsed = false } = {}) {
  ...
  const compact = manualCollapsed === true || (pastThreshold && manualExpanded !== true);
