...
REM One-click upload + remote redeploy for shizuki-site
...
echo [2/3] Uploading local code and deploying...
...
if errorlevel 1 (
  echo [ERROR] Upload + redeploy failed.
  pause
  exit /b 1
)

echo [3/3] Upload + redeploy finished successfully.
pause
