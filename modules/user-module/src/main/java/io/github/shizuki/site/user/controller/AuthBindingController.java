...
public class AuthBindingController {
    ...
    public ApiResponse<ActionStatusResponse> bindEmail(@Valid @RequestBody EmailBindRequest request) {
    ...
    public ApiResponse<ActionStatusResponse> bindOAuth(@Valid @RequestBody OAuthBindRequest request) {
