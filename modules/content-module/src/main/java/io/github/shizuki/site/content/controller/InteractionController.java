...
public class InteractionController {
    ...
    public ApiResponse<PostLikeResponse> likePost(@PathVariable("post_id") Long postId) {
    ...
    public ApiResponse<AppLikeResponse> likeApp(@PathVariable("app_id") Long appId) {
    ...
    public ApiResponse<ContentReportCreateResponse> report(@Valid @RequestBody ReportRequest request) {
