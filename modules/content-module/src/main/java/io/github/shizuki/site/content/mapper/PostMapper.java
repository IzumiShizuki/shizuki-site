...
public interface PostMapper extends BaseMapper<PostEntity> {
    ...
    @Select("""
        ...
        ORDER BY COALESCE(p.published_time, p.create_time) DESC, p.id DESC
        </script>
        """)
    List<PostEntity> selectVisiblePublishedPostsRaw(@Param("userId") Long userId,
                                                    @Param("groupCodes") Set<String> groupCodes);
    ...
    @Select("""
        ...
        """)
    List<PostEntity> selectAuthorPosts(@Param("userId") Long userId);
}
