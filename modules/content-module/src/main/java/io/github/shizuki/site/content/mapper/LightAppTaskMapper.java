...
@Mapper
public interface LightAppTaskMapper extends BaseMapper<LightAppTaskEntity> {

    @Select("SELECT MAX(sort_num) FROM CTN_LA_TASK WHERE user_id = #{userId} AND deleted_flag = 0")
